...
uint8_t Alarm[] = {0x01,0x08,0x00,0x02,0x00,0x00,0x06};
uint8_t OpenDoorLock[] = {0x01,0x05,0x00,0x0D,0x00,/*Header*/
                            0x00,/*sequence number*/  0x01,/*type*/ 0x01,/*user id*/ 0x00,/*command*/ 0x08,/*len*/ 0x2A, 0x30, 0x37, 0x34, 0x36, 0x39, 0x33, 0x23};
uint8_t AddUser[] = {0x01,0x03,0x00,0x04,0x00,/*Header*/
                            0x00, 0x02,/*type*/ 0x03,/*id*/ 0x03/*perm*/};
uint8_t DelUser[] = {0x01,0x04,0x00,0x02,0x00,
                            0x00,0x03};
uint8_t PowerReport[] = {0x01,0x07,0x00,0x03,0x00,
                            0x00,0x00,0x1e};
uint8_t LocalOpenDoor[] = {0x01,0x06,0x00,0x03,0x00,/*Header*/
                            0x00, 0x02, /*type*/0x03/*id*/};
...
LinkMessage_t LinkMessage[] = {
    ...
    {0x0108,"Alarm",Alarm,sizeof(Alarm)},
    {0x0104,"DelUser",DelUser,sizeof(DelUser)},
    {0x0107,"PowerReport",PowerReport,sizeof(PowerReport)},
};
